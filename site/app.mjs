import { itemType, parseGopherUrl, parseMenu } from "./protocol.mjs?v=2.1.2";
...
try {
  const response = await fetch("fixtures/root.txt?v=2.1.2");
...
if ("serviceWorker" in navigator) {
  try {
    await navigator.serviceWorker.register("./sw.js?v=2.1.2", { scope: "./", updateViaCache: "none" });
