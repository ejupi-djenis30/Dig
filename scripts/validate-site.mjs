...
for (const required of ['lang="en"', "<title>", "<main", "aria-label", "Fixture mode", 'rel="manifest"', "readonly", '<meta name="referrer" content="no-referrer" />', 'http-equiv="Content-Security-Policy"', `content="${expectedCsp}"`]) {
